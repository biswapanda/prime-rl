...
echo "[smoke] Monitor with: python tools/rl_monitor.py --output-dir $OUTPUT_DIR --once"
echo "[smoke] Plot with:    python tools/rl_plot.py --orch-log $ORCH_LOG --trainer-log $TRAINER_LOG"
