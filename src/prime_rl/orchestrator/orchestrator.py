...
async def orchestrate(config: OrchestratorConfig):
    ...
    if hasattr(student_inference._admin_api, "_weight_broadcast_type"):
        student_inference._admin_api._weight_broadcast_type = config.weight_broadcast.type
    if config.weight_broadcast.type == "nccl":
        await init_nccl_broadcast(
            ...
            admin=student_inference._admin_api,
        )
